...
export default class Profile extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      recs: {
        "204": ["Total lipid (fat)", 65],
        "606": ["Fatty acids, total saturated", 20],
        "601": ["Cholesterol", 300],
        "307": ["Sodium, Na", 2400],
        "306": ["Potassium, K", 3500],
        "205": ["Carbohydrate, by difference", 300],
        "291": ["Fiber, total dietary", 25],
        "203": ["Protein", 50],
        "318": ["Vitamin A, IU", 5000],
        "401": ["Vitamin C, total ascorbic acid", 60],
        "301": ["Calcium, Ca", 1000],
        "303": ["Iron, Fe", 18],
        "324": ["Vitamin D", 400],
        "323": ["Vitamin E (alpha-tocopherol)", 30],
        "430": ["Vitamin K (phylloquinone)", 80],
        "404": ["Thiamin", 1.5],
        "405": ["Riboflavin", 1.7],
        "406": ["Niacin", 20],
        "415": ["Vitamin B-6", 2],
        ...
        "418": ["Vitamin B-12", 6],
        "N/A": ["Biotin", 300],
        "410": ["Pantothenic acid", 10],
        "305": ["Phosphorus, P", 1000],
        "N/A 2": ["Iodine, I", 150],
